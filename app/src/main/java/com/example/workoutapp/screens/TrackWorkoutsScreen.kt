...
import com.example.workoutapp.screens.helpers.IconMapper
...
@Composable
fun TrackWorkoutsScreenContent(
    ...
    Log.d("TrackWorkoutsScreenContent", "I got recomposed")
                ...
                items(workouts.workouts.size) { idx ->
                    RenderWorkoutCard(
                        ...
                        onClick = {
                            ...
                            navController.navigate(Screen.TrackWorkoutSummaryScreen.route) {
...
fun TrackWorkoutsScreen(
    ...
    ScreenWithApiUsage(
        ...
        content = {
            TrackWorkoutsScreenContent(
                navController = navController,

                workoutApiRequestState = trackWorkoutsScreenViewModel.workoutApiRequestState,

                workouts = trackWorkoutsScreenViewModel.workouts,
                updateWorkouts = { trackWorkoutsScreenViewModel.updateUserWorkouts() },

                updateSelectedWorkoutIdx = { idx -> trackWorkoutsScreenViewModel.updateSelectedIdx(idx) },
...
@Composable
fun TrackWorkoutsScreenContentPreview() {
    WorkoutAppTheme {
        TrackWorkoutsScreenContent(
